    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                @can('nav_access')
                    <li class="nav-item">
                        <a href="{{ route("admin.navs.index") }}" class="nav-link {{ request()->is("admin/navs") || request()->is("admin/navs/*") ? "active" : "" }}">
                            <i class="fa-fw nav-icon fas fa-sitemap">

                            </i>
                            <p>
                                {{ trans('cruds.nav.title') }}
                            </p>
                        </a>
                    </li>
                @endcan
                ...
                @can('header_access')
                    <li class="nav-item">
                        <a href="{{ route("admin.headers.index") }}" class="nav-link {{ request()->is("admin/headers") || request()->is("admin/headers/*") ? "active" : "" }}">
